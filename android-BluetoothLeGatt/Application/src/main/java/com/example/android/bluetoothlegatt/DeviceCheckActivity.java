...
public class DeviceCheckActivity extends Activity {
    ...
    protected void initializeDeviceLayout() {
        ...
        Button addDeviceButton = new Button(getApplicationContext());
        addDeviceButton.setText(getResources().getString(R.string.add_device));
        ...
        buttonsLayout.addView(addDeviceButton);
